...
| 6 Graph and Math Box (in progress: **M1 Math Box in Engine ✅**, **M2 its screens ✅**, **M3 Graphing ✅**, **M4 the graph in Table ✅**, M5 hardening) | Graphing; Dice, Coin, Number Line, Circle | Every conformance case passes, none skipped |
