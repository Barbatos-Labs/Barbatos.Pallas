...
- **Public API discipline.** The first release is 1.0.0 (maintainer, 24 Sep 2026), not a 0.x preview, so semantic
  ...
  - `Microsoft.CodeAnalysis.PublicApiAnalyzers` tracks the public surface (Phase 7, before 1.0.0 is published);
...
| 7 Hardening | Benchmarks and gates, API docs, public API tracking, publish pipeline | 1.0.0 on nuget.org |
