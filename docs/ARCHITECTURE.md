...
- **Keypad as data.**
  ...
  - Hardware keys map into the *same* table (`KeyboardMap`), so the on-screen keypad and the keyboard cannot behave
    differently.
- **MathInput.**
...
| 5 WPF (in progress: **M1 shell ✅**, **M2 keypad and math input ✅**, **M3 Calculate ✅**, **M4 the other screens ✅**, M4.5 the calculator's face - **a layout and look ✅**, **b a keypad per application ✅**, c CATALOG -, M5 persistence and shortcuts, M6 hardening and installer) | Presentation, keypad, MathInput, rendering, thirteen applications, settings, i18n, history | Every manual workflow runs in the app |
