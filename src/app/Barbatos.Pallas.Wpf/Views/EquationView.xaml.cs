...
/// <summary>
/// The Equation screen: coefficients, and what they come to.
/// </summary>
public partial class EquationView : UserControl
{
    ...
    public EquationView(CalculatorShellViewModel shell)
    {
        ArgumentNullException.ThrowIfNull(shell);
        InitializeComponent();
        DataContext = shell.Equation;
    }
}
