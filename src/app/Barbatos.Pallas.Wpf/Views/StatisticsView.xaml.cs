...
/// <summary>
/// The Statistics screen: the data, the regression, and the statistics of both.
/// </summary>
public partial class StatisticsView : UserControl
{
    ...
    public StatisticsView(CalculatorShellViewModel shell)
    {
        ArgumentNullException.ThrowIfNull(shell);
        InitializeComponent();
        DataContext = shell.Statistics;
    }
}
