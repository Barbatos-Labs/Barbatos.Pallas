...
/// <summary>
/// The Base-N screen: which base the calculator counts in, and the line it counts on.
/// </summary>
public partial class BaseNView : UserControl
{
    ...
    public BaseNView(CalculatorShellViewModel shell)
    {
        ArgumentNullException.ThrowIfNull(shell);
        InitializeComponent();
        DataContext = shell.BaseN;
    }
}
