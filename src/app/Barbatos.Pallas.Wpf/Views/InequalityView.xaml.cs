...
/// <summary>
/// The Inequality screen: a polynomial, a relation, and the x it holds for.
/// </summary>
public partial class InequalityView : UserControl
{
    ...
    public InequalityView(CalculatorShellViewModel shell)
    {
        ArgumentNullException.ThrowIfNull(shell);
        InitializeComponent();
        DataContext = shell.Inequality;
    }
}
